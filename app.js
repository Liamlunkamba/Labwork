...
let travelTime= milesToDestination / 55

console.log(Equation);
console.log(pricePerGallons);
console.log(travelTime);

console.log("It would take " + travelTime + ' hours to get to where we want to on 55 miles per hour.' )

Equation = milesToDestination / sixtyMPH;
pricePerGallons = gasEquation * 3;
travelTime = milesToDestination / 60
...
pricePerGallons = gasEquation * 3;
travelTime = milesToDestination / 75
...
function makeItEasier(miles, MPH){
  ...
  let travelTime = milesToDestination / miles;
